        ...
        <div class="container">
            <div class="row">
                <div class="span12">
                    ...
                    <div class="parallax" id="page-header" style="background-image:url(content/backgrounds/ww.png);">
                        <img src="content/backgrounds/white.png" alt="">
                            ...
                            <div id="respond" class="comment-respond">
                                ...
                                <form action="book-now.php" method="post" id="commentform" class="comment-form fixed" novalidate>
                                    ...
                                    <p class="comment-form-email">
                                        ...
                                        <input id="email" name="email" type="email" value="" size="30" aria-required="true" placeholder="enter your email address">
                                    </p>
                    ...
                    <div class="span12" id="footer-bottom-widget-area-1">
                        ...
                        <div class="widget widget_text">
                            ...
                            <div class="textwidget">
                               <p><strong class="text-uppercase">DreamWalk</strong> &copy; 2023. </p>                            </div>
