...
<head>
	...
	<meta name="DreamWalk is fictioral bus company in the Philippines  " content=" " >
            ...
            <div class="container">
            	<div class="row">
                	<div class="span13">
                        ...
                        <div class="main-slider">
							...
							<ul class="main-slider__slides" data-slick='{ "fade": true, "speed": 500, "autoplay": false, "infinite": true, "dots": true, "arrows": false }'>
								<li style="background-image:url('content/backgrounds/p.png');">
                    ...
                    <div class="span12">
                        ...
                        <div class="service-box" style="background-image:url(content/services/600x600-4.jpg)">
                            
                            <div class="subheadline">
                            
                                <h3>Check the Routes and Schedule</h3>
                                
                            </div><!-- end .subheadline -->
                            
                            <p>Main routes focuses on the buses going to the North, which includes the buses Northbound  within  NCR  and  buses  going  to  provinces  north  of  the  NCR.  This app includes features that  show the buses’ arrival and departure times according to the bus liner’s  policies,  the  route  used  by  the  buses  bound  to  a  specific  location,  and  the availability of seats within each buses scheduled to depart at a given time. As such, this application is expected to be more of a bulletin board than an actual travel guide. Sales of tickets and lodging are also included on this application. <p>
                            
                            <a class="btn" href="schedule.php">Go to Schedule</a>
