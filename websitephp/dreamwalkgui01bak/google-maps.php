            ...
            <div class="container">
                <div class="row">
                    <div class="span12">
                        ...
                        <p>Pellentesque risus metus, elementum eget feugiat nec, fringilla eget urna. Integer egestas accumsan augue 
                        sit amet placerat. Nunc interdum, lacus at venenatis feugiat, nisl ipsum bibendum nunc, non elementum turpis 
                        mauris eget massa. Quisque sapien purus, consequat eu vehicula a, aliquam ut orci. Fusce at blandit nisi. 
                        Maecenas sodales urna est, a sollicitudin orci placerat eget. Ut vitae fringilla eros. Donec feugiat venenatis 
                        augue, et elementum turpis venenatis sed. Ut tristique laoreet sapien, vitae vestibulum lectus imperdiet quis. </p>
                ...
                <div class="row">
                    <div class="span12">
                        ...
                        <div class="google-map map" 
                            data-zoom="15" 
                            data-address="San Francisco, Statele Unite ale Americii" 
                            data-caption="2082 Stanton Hollow, <br>San Francisco, <br>781-500-6238, <br><a href='mailto:#'>office@solid.com</a>"
                            data-maptype="ROADMAP"
                            data-mapheight="600">
                            <p>This will be replaced with the Google Map.</p>
                        </div>
                        <div class="google-map">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d14767.338181560746!2d121.01459604970869!3d14.543560095955305!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sph!4v1677867302931!5m2!1sen!2sph" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                       </div>
                    </div><!-- end .span12 -->
                </div><!-- end .row -->
            </div><!-- end .container -->
            ...
            <div class="container">
                <div class="row">
                    <div class="span12">
                        ...
                        <p>Curabitur tristique nisi ac augue convallis molestie. Praesent porta purus et erat faucibus fermentum. 
                        Suspendisse purus orci, pellentesque a tellus nec, feugiat ultrices nisi. Suspendisse eu varius risus. 
                        Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Aenean ultrices 
                        malesuada volutpat. Aenean eget augue non orci luctus scelerisque. Donec pellentesque ultrices tempus. 
                        Fusce fringilla vitae sem eu molestie. In erat ligula, tristique ut mauris sit amet, dapibus molestie diam. 
                        Nam eu nunc ante. </p>
