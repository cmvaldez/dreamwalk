        ...
        <div class="span3">
            ...
            <div class="pricing-table">
                ...
                <div class="pricing-table-header">
                    ...
                    <h2><strong>Bus Route</strong></h2>
                    <h3>Pasay to Pampanga</h3>
                    <h1>
                        <sup></sup>
                        3:00
                        <small> hrs</small>
                ...
                <div class="pricing-table-offer">
                    ...
                    <ul>
                        <li>04:30H to 07:30H</li>
                        <li>06:00H to 10:00H </li>
                        <li>12:00H to 15:00H</li>
                    ...
                    <div class="span3">
                        ...
                        <div class="pricing-table">
                            ...
                            <div class="pricing-table-offer">
                                ...
                                <ul>
                                    <li>08:00H to 11:00H</li>
                                    <li>09:00H to 12:00H </li>
                                    <li>15:00H to 18:00H</li>
                                </ul>
            ...
            <div class="span3">
                ...
                <div class="pricing-table">
                    ...
                    <div class="pricing-table-offer">
                        ...
                        <ul>
                            <li>07:00H to 10:00H</li>
                            <li>03:00H to 06:00H </li>
                            <li>12:30H to 15:30H</li>
        ...
        <div class="span3">
            ...
            <div class="pricing-table">
                ...
                <div class="pricing-table-offer">
                    ...
                    <ul>
                        <li>03:00H to 07:30H</li>
                        <li>07:00H to 12:30H</li>
                        <li>13:00H to 17:30H </li>
    ...
    <div class="span3">
        ...
        <div class="pricing-table">
            ...
            <div class="pricing-table-header">
                ...
                <h2><strong>Bus Route</strong></h2>
                <h3>Pasay to Cabanatuan City</h3>
                <h1>
                    <sup></sup>
                    3:00
                    <small> hrs</small>
            ...
            <div class="pricing-table-offer">
                ...
                <ul>
                    <li>08:30H to 11:30H</li>
                    <li>03:30H to 06:30H </li>
                    <li>17:00H to 20:00H</li>
                </ul>
...
<div class="span3">
    ...
    <div class="pricing-table">
        ...
        <div class="pricing-table-offer">
            ...
            <ul>
                <li>02:00H to 07:00H</li>
                <li>08:00H to 13:00H </li>
                <li>23:00H to 04:00H</li>
...
<div class="span3">
    ...
    <div class="pricing-table">
        ...
        <div class="pricing-table-offer">
            ...
            <ul>
                <li>04:00H to 11:00H</li>
                <li>08:00H to 15:00H</li>
                <li>12:00H to 19:00H</li>
            </ul>
